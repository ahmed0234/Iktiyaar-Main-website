...
const faqs = [
  {
    ...
    answer:
      "Most Clients seeing SEO results within the first month as search engines begin indexing and recognizing your improvements. Real growth typically builds from 2 to 3 months and keeps compounding as your authority strengthens over time.",
  },
  {
    question: "What makes your SEO approach different from other agencies?",
    answer:
      "We don't just chase rankings — we engineer revenue. Every strategy is tied to commercial outcomes. We combine AI-powered analysis with deep human expertise, and we integrate SEO with your entire marketing stack for maximum impact.",
  },
  {
    question: "Do you guarantee first-page rankings?",
    answer:
      "No ethical SEO agency can guarantee specific rankings because Google's algorithm is outside anyone's control. What we do guarantee is a systematic, proven process that has consistently delivered page 1 rankings and revenue growth for our clients.",
  },
  {
    question: "How do you report on progress?",
    answer:
      "You get access to a real-time dashboard showing keyword rankings, traffic, conversions, and revenue attribution. Plus, you'll receive detailed monthly reports with insights, wins, and the strategic next steps — no jargon, just clarity.",
  },
  {
    question: "Can you work alongside our existing marketing team?",
    answer:
      "Absolutely. We integrate seamlessly with internal teams, existing agencies, and your tech stack. We're not here to replace your team — we're here to amplify what's already working and fill in the gaps.",
  },
];
