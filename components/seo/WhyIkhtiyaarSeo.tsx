...
const differentiators = [
  {
    ...
    description:
      "We don't chase vanity metrics. Every SEO action we take is connected to a revenue outcome — not just traffic.",
  },
  {
    icon: LineChart,
    title: "Transparent Reporting",
    description:
      "Real-time dashboards showing exactly what we're doing, what's ranking, and how it's affecting your bottom line.",
  },
  {
    icon: Sparkles,
    title: "AI-Enhanced Workflows",
    description:
      "We combine human expertise with AI-powered analysis for faster keyword research, content optimization, and opportunity discovery.",
  },
  {
    icon: Globe,
    title: "Full-Funnel Integration",
    description:
      "Our SEO doesn't work in isolation. We connect search traffic to your CRM, attribution models, and conversion systems.",
  },
];

export default function WhyIkhtiyaarSeo() {
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-[2.8rem] font-[900] tracking-tight text-slate-900 leading-[1.1] mb-6">
              <WordReveal text="SEO That Doesn't" delay={0.1} />
              <br className="hidden sm:block" />
              <span className="text-black bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400">
                <WordReveal text="Just Rank It Sells" delay={0.4} />
              </span>
            </h2>
            ...
            >
              Most agencies obsess over rankings. We obsess over what happens after
              the click. Every page we optimize, every piece of content we create,
              and every link we earn is designed with one mission: make the phone
              ring.
            </motion.p>
          ...
          >
            ...
            >
              <div className="relative w-full aspect-square">
                <Image
                  src="/seoPage/image_7.png"
                  alt="Growth arrow with city skyline data visualization"
                  fill
            ...
            >
              ...
              >
                <Image
                  src="/seoPage/image_8.png"
                  alt="Green holographic growth chart"
                  fill
