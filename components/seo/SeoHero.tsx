...
function AnimatedGraph() {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id="seoGraphGradient" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#4285F4" stopOpacity="0.25" />
          <stop offset="100%" stopColor="#4285F4" stopOpacity="0.02" />
        </linearGradient>
        <linearGradient id="seoLineGradient" x1="0" y1="0" x2="1" y2="0">
      ...
      <path d={areaPath} fill="url(#seoGraphGradient)" />
      <path
        d={pathData}
        fill="none"
    ...
    >
      ...
      >
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          {/* ── Right — Dynamic Animated Visual System (from Google Ads) ── */}
          <div
