...
const roadmapSteps = [
  {
    icon: Eye,
    label: "Awareness",
    description: "Your brand gets noticed by the ideal audience",
    color: "#3B82F6",
    bgFrom: "from-blue-50",
    bgTo: "to-blue-100/60",
  ...
  },
  {
    icon: Heart,
    label: "Engagement",
    description: "People interact, like, and remember you",
    color: "#EC4899",
    bgFrom: "from-pink-50",
    bgTo: "to-pink-100/60",
  ...
  },
  {
    icon: Magnet,
    label: "Leads",
    description: "Qualified prospects enter your pipeline",
    color: "#8B5CF6",
  ...
  },
  {
    icon: ShoppingBag,
    label: "Conversion",
    description: "Clicks become paying customers",
    color: "#F59E0B",
  ...
  },
  {
    icon: TrendingUp,
    label: "Growth",
    description: "Revenue scales predictably over time",
    color: "#10B981",
...
/* ── Main Export ──────────────────────────────────────────────── */
export default function MetaAdsDeliver() {
  ...
  return (
    <section
      ref={ref}
      className="relative py-24 sm:py-28 overflow-hidden bg-white"
    >
      {/* Atmospheric orbs */}
      <motion.div
        ...
        <div className="flex flex-col lg:flex-row items-start gap-16 lg:gap-20">
          ...
          <div className="w-full lg:w-[50%] lg:sticky lg:top-32">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-[2.8rem] font-[900] tracking-tight text-slate-900 leading-[1.1] mb-6">
              <WordReveal text="What High-Performing" delay={0.15} />
              <br className="hidden sm:block" />
              <span className="text-black bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400">
                <WordReveal text="Meta Ads Deliver" delay={0.5} />
              </span>
            </h2>
            ...
            >
              When Meta Ads are executed correctly, they become a powerful tool
              for growth. With Ikhtiyaar, you can expect:
            </motion.p>
