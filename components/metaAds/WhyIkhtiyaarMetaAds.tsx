...
const differentiators = [
  {
    ...
    description:
      "We don't chase vanity metrics like cheap clicks. Every ad we launch is optimized for a revenue outcome — converting attention into profit.",
  },
  {
    icon: LineChart,
    title: "Data-Driven Scaling",
    description:
      "We continuously test creatives and audiences, scaling the winners aggressively while cutting the losers to maximize your return on ad spend.",
  },
  {
    icon: Sparkles,
    title: "Scroll-Stopping Creative",
    description:
      "We combine deep audience insights with high-performing creative formats to break through the noise and capture high-intent users.",
  },
  {
    icon: Globe,
    title: "Full-Funnel Integration",
    description:
      "Our ads don't work in isolation. We seamlessly connect top-of-funnel traffic to your backend systems for accurate attribution and growth.",
  },
];

export default function WhyIkhtiyaarMetaAds() {
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-[2.5rem] font-[900] tracking-tight text-slate-900 leading-[1.1] mb-6">
              <WordReveal text="Meta Ads That Don’t Spend" delay={0.1} />
            ...
            >
              Most agencies obsess over cheap clicks and vanity metrics. We obsess over what happens after
              the click. Every ad we design, every audience we target,
              and every campaign we scale is built with one mission: to maximize your ROI and generate real business growth.
            </motion.p>
          ...
          >
            ...
            >
              <div className="relative w-full aspect-square">
                <Image
                  src="/metaAdsPage/Floating_Instagram3d.png"
            ...
            >
              ...
              >
                <Image
                  src="/metaAdsPage/metaAdsImage.png"
                  alt="3D Instagram floating icon"
                  fill
