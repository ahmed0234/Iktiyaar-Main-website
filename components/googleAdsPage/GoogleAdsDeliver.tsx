...
const deliverables = [
  "Attracting the right audience with precision targeting",
  "Converting traffic efficiently with optimized landing pages",
  "Scaling profitably through continuous data analysis",
  "Aligning keyword strategy with overall business goals",
  "Seamless integration from keyword to conversion",
];
...
const roadmapSteps = [
  {
    icon: Search,
    label: "Search",
    description: "Capturing high-intent users actively looking for your services.",
    color: "#3B82F6",
    bgFrom: "from-blue-50",
    bgTo: "to-blue-100/60",
  ...
  },
  {
    ...
    label: "Click",
    description: "Compelling ad copy that drives qualified traffic to your site.",
    color: "#EC4899",
    bgFrom: "from-pink-50",
    bgTo: "to-pink-100/60",
  ...
  },
  {
    icon: LayoutTemplate,
    label: "Landing Page",
    description: "Optimized destinations designed to maximize conversions.",
    color: "#8B5CF6",
  ...
  },
  {
    icon: BadgeCheck,
    label: "Conversion",
    description: "Turning clicks into qualified leads and paying customers.",
    color: "#F59E0B",
  ...
  },
  {
    icon: TrendingUp,
    label: "Optimization",
    description: "Continuous data-driven refinements for maximum ROI.",
    color: "#10B981",
...
/* ── Main Export ──────────────────────────────────────────────── */
export default function GoogleAdsDeliver() {
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center gap-16 lg:gap-20">
          ...
          <div className="w-full lg:w-[50%] lg:sticky lg:top-32">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-[2.8rem] font-[900] tracking-tight text-slate-900 leading-[1.1] mb-6">
              <WordReveal text="We Don't Just Run Ads" delay={0.15} />
              <br className="hidden sm:block" />
              <span className="text-black bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400">
                <WordReveal text="We Build Revenue Systems" delay={0.5} />
              </span>
            </h2>
            ...
            >
              At Ikhtiyaar, Google Ads isn't treated as a standalone channel. We build a complete acquisition system focused on attracting the right audience, converting them efficiently, and scaling profitably.
            </motion.p>
            ...
            >
              <p className="text-[15px] text-red-500 leading-relaxed font-medium">
                No random campaigns. No wasted spend.{" "}
                <span className="font-bold">
                  Just structured, data-driven growth.
                </span>
              </p>
            </motion.div>
          </div>
