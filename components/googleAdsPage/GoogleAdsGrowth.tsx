...
const funnelSteps = [
  {
    ...
    description: "Targeting high-intent keywords that drive sales",
  },
  {
    icon: Target,
    label: "Targeting",
    ...
    description: "Precision audience and placement segmentation",
  },
  {
    ...
    description: "Compelling ad copy to maximize click-throughs",
  },
  {
    icon: ShoppingCart,
    label: "Conversion",
  ...
  },
  {
    ...
    description: "Continuous optimization to maximize your ROAS",
  },
];
...
/* ── Main Export ──────────────────────────────────────────────── */
export default function GoogleAdsGrowth() {
  ...
  return (
    <section
      ref={ref}
      className="relative py-12 sm:py-10 overflow-hidden bg-gradient-to-b from-white via-slate-50/30 to-white"
    >
      {/* Dot pattern */}
      <div
          ...
          >
            ...
            >
              ...
              <p className="text-[11px] font-[900] text-slate-700">
                <span className="text-emerald-600">+240%</span> ROAS Increase
              </p>
            </motion.div>
          </motion.div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-[3rem] font-[900] tracking-tight text-slate-900 leading-[1.1] mb-5">
            <WordReveal text="We Turn Search Traffic" delay={0.1} />
            <br className="hidden sm:block" />{" "}
            <span className="text-black bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400">
              <WordReveal text="Into a Growth Engine" delay={0.4} />
            </span>
          </h2>
          ...
          >
            At Ikhtiyaar, Google Ads are not just about buying clicks
            they&apos;re about building an intelligent system that drives consistent
            results. We combine{" "}
            <span className="text-slate-800 font-bold">search intent</span>,{" "}
            ...
            to deliver campaigns that don&apos;t just burn budget they
            generate revenue.
          </motion.p>
          ...
          >
            From account structure to bid strategies, everything is built with
            one goal:{" "}
          ...
          >
            No vanity metrics. No guesswork. Just scalable performance.
          </motion.p>
        </div>
