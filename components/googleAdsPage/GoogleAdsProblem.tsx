...
const struggles = [
  {
    text: "Campaigns are poorly structured",
    icon: Ban,
    description: "No clear ad groups, no intent segmentation",
  },
  {
    text: "Budget is wasted on low-quality clicks",
    icon: CircleDollarSign,
    description: "Broad targeting drains spend without conversions",
  },
  {
    text: "Keywords target traffic, not buyers",
    icon: SearchX,
    description: "High impressions, zero purchase intent",
  },
  {
    text: "No proper tracking or conversion optimization",
    icon: Crosshair,
    description: "Flying blind without measurable performance data",
  },
];
...
// ═══════════════════════════════════════════════════════════════════════
export default function GoogleAdsProblem() {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
          ...
          >
            ...
            >
              <div className="relative w-full aspect-[4/3]">
                <Image
                  src="/googleAds/ad_spend_waste.png"
                  alt="Wasted ad spend and declining campaign performance"
                  fill
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <p className="text-2xl font-[900] text-slate-800 leading-none">
                    3<span className="text-sm text-slate-400 font-bold">/10</span>
                  </p>
                  <DecliningMetric />
                </div>
            ...
            >
              ...
              >
                ...
                <p className="text-[12px] font-[800] text-slate-700">
                  <span className="text-red-500">–72%</span> Wasted Ad Spend
                </p>
              </motion.div>
            </motion.div>
          ...
          <div className="w-full lg:w-[55%]">
            ...
            >
              Google Ads can scale a business fast but only when it&apos;s
              executed correctly. Most businesses struggle because:
            </motion.p>
            ...
            >
              ...
              <div className="relative pl-5 border-l-[3px] border-red-400/50 max-w-lg">
                <p className="text-[15px] text-slate-500 leading-relaxed font-medium italic">
                  You might be getting clicks — but clicks don&apos;t pay the
                  bills.{" "}
                  <span className="text-slate-800 font-bold not-italic">
                    Without the right system, ad spend turns into guesswork.
                  </span>
                </p>
              </div>
            </motion.div>
