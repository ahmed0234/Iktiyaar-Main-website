...
const faqs = [
  {
    question: "How soon will I see results from my Google Ads?",
    answer:
      "Google Ads deliver high-intent traffic instantly. While the initial data gathering phase takes 7–14 days, most clients see profitable ROAS within the first 2 to 4 weeks as we optimize bids, keywords, and search intent targeting.",
  },
  {
    question: "What makes your Google Ads strategy different from other agencies?",
    answer:
      "We focus on intent-driven conversions, not just clicks. We don't just bid on broad keywords; we engineer high-converting ad copy and tight account structures that capture searchers exactly when they are ready to buy, maximizing your ROI.",
  },
  {
    question: "How much ad spend do I need to start with?",
    answer:
      "Budget depends on your specific industry's CPC and conversion goals. We typically recommend a starting test budget that allows enough clicks to identify high-converting keywords and optimize for the lowest possible cost per acquisition.",
  },
  {
    question: "How do you track and report on actual ROAS?",
    answer:
      "We use a combination of Google Tag Manager, advanced conversion tracking, and offline conversions integration to ensure data accuracy. You'll get a real-time dashboard showing exactly which keywords drive profit, with zero vanity metrics.",
  },
  {
    question: "We tried ads before and it didn't work.",
    answer:
      "Most businesses that tried ads and gave up were victims of the wrong strategy. They focused on low-intent clicks or used outdated campaign structures that burned money without delivering results. We fix that by starting with a clean slate analyzing your past campaigns, identifying what actually drove revenue, and rebuilding your ads from the ground up with a focus on intent-driven conversions.",
  },
];
