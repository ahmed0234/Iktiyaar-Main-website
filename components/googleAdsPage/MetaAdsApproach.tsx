...
const approachSteps = [
  {
    ...
    description:
      "We start by understanding your audience, offer, and business goals to craft a data-driven advertising blueprint. Every campaign begins with clarity — not guesswork.",
    details: [
      "Deep audience analysis & persona mapping",
      "Competitor ad intelligence & positioning",
      "Custom funnel strategy aligned to your goals",
    ],
    icon: Search,
    accentIcon: Target,
  ...
  },
  {
    ...
    description:
      "We launch campaigns with multiple creative variations and audience segments, then rigorously test what performs best. Every dollar is monitored from day one.",
    details: [
      "Multi-variant creative testing at scale",
      "Audience segmentation & split testing",
  ...
  },
  {
    ...
    details: [
      ...
      "Profitable scaling with controlled spend",
      "Continuous A/B testing & iteration cycles",
    ],
    icon: TrendingUp,
...
export default function MetaAdsApproach() {
  ...
  return (
    <section
      ref={ref}
      className="relative py-24 sm:py-32 overflow-hidden bg-gradient-to-b from-slate-50/60 via-white to-slate-50/40"
    >
      {/* Subtle dot pattern */}
      <div
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16 lg:mb-20">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-[3rem] font-[900] tracking-tight text-slate-900 leading-[1.1] mb-5">
            <WordReveal text="Our Meta Ads" delay={0.1} />
        ...
        >
          <p className="text-sm text-slate-400 font-semibold tracking-wide">
            No random boosting. No guesswork.{" "}
