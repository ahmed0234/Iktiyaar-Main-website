          ...
          <div className="relative overflow-hidden rounded-[2rem] sm:rounded-[2.5rem]">
            ...
            <div className="relative z-10 px-8 sm:px-12 lg:px-16 py-14 sm:py-16 lg:py-20 flex flex-col items-center text-center gap-8">
              ...
              <motion.p
                ...
                className="text-base sm:text-lg text-blue-100/80 font-medium max-w-xl leading-relaxed"
              >
                Book a free Google Ads Audit. We will show you exactly where your
                conversions are slipping, which audiences and creatives to focus
                on first, and how to turn paid traffic into a consistent revenue
                engine.
              </motion.p>
