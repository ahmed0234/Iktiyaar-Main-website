...
const features = [
  ...
  "Higher response and reply rates",
  "Direct access to decision-makers",
  "Reduced reliance on paid ads",
  "Predictable outbound growth",
];

export default function ColdEmailFeatures() {
  ...
  return (
    <section
      ref={ref}
      className="relative py-14 sm:py-2 overflow-hidden bg-gradient-to-b from-slate-50/50 via-white to-slate-50/30"
    >
      {/* Background Orbs */}
      <motion.div
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 order-2 lg:order-1">
            <h2 className="text-3xl sm:text-4xl lg:text-[2.5rem] font-[900] tracking-tight text-slate-900 leading-[1.1] mb-6">
              <WordReveal text="What Effective Cold Email" delay={0.1} />
              <br className="hidden sm:block" />
              <span className="text-black bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-500">
                <WordReveal text="Can Do For Your Growth" delay={0.4} />
              </span>
            </h2>
            ...
            >
              When done right, cold email becomes a consistent and scalable lead generation channel.
            </motion.p>
            ...
            <motion.div
              ...
              className="border-l-[3px] border-blue-400 pl-4"
            >
              <p className="text-lg sm:text-xl font-[800] text-slate-800 italic">
                More conversations. More opportunities. <span className="text-blue-600">More growth.</span>
              </p>
            </motion.div>
            ...
            >
              ...
              >
                <div className="relative w-full h-full">
                  <Image
                    src="/ColdEmail/coldEmail.png"
                    alt="Effective Cold Email ROI Funnel"
                    fill
              ...
              <motion.div
                ...
                style={{ y: floatY1 }}
                className="absolute top-[-4%] -left-4 sm:-left-30 z-20"
              >
                <motion.div
                  animate={{ y: [-4, 4, -4] }}
                  transition={{ repeat: Infinity, duration: 5, ease: "easeInOut" }}
                  whileHover={{ scale: 1.05 }}
                  className="bg-white/95 backdrop-blur-md rounded-2xl p-4 shadow-xl border border-slate-100/80 min-w-[160px]"
                >
                  ...
                  <div className="flex items-baseline gap-1.5">
                    <p className="text-xl font-[900] text-slate-900 leading-none">+178%</p>
                    <p className="text-[10px] font-bold text-emerald-600">Qualified Leads</p>
                  </div>
                </motion.div>
              </motion.div>

              {/* ── Floating Badge: Reply Rate ── */}
              <motion.div
                initial={{ opacity: 0, x: 30 }}
                animate={isInView ? { opacity: 1, x: 0 } : {}}
                transition={{ duration: 0.6, delay: 1.0 }}
                style={{ y: floatY2 }}
                className="absolute bottom-[15%] -right-4 sm:-right-28 z-20"
              >
                <motion.div
                  animate={{ y: [4, -4, 4] }}
                  transition={{ repeat: Infinity, duration: 6, ease: "easeInOut" }}
                  whileHover={{ scale: 1.05 }}
                  className="bg-white/95 backdrop-blur-md rounded-2xl p-4 shadow-xl border border-blue-100 min-w-[160px]"
                >
                  <div className="flex items-center gap-2 mb-1.5">
                  ...
                  <div className="flex items-baseline gap-1.5">
                    <p className="text-xl font-[900] text-slate-900 leading-none">+72%</p>
                    <p className="text-[10px] font-bold text-blue-600">Reply Rate</p>
                  </div>
                </motion.div>
              </motion.div>
