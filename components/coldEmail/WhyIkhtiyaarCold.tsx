...
import { Zap, LineChart, Sparkles, Target } from "lucide-react";
...
const differentiators = [
  {
    ...
    description:
      "We don't just send mass emails. We identify and verify your ideal prospects, ensuring you reach the exact decision-makers who need your solution.",
  },
  {
    icon: Sparkles,
    title: "AI Personalization",
    description:
      "We leverage advanced AI to craft highly relevant, unique messages for every prospect, breaking through the noise and starting real conversations.",
  },
  {
    icon: Zap,
    title: "High Deliverability",
    description:
      "Our technical experts ensure your emails land in the primary inbox, not spam, by managing your sender reputation and domain health.",
  },
  {
    icon: LineChart,
    title: "Data-Driven Growth",
    description:
      "We continuously test and optimize every campaign, from subject lines to timing, to maximize your reply rates and booked meetings.",
  },
];

export default function WhyIkhtiyaarCold() {
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-[2.1rem] font-[900] tracking-tight text-slate-900 leading-[1.1] mb-6">
              <WordReveal text="Outreach That Doesn’t Just Send" delay={0.1} />
              <br className="hidden sm:block" />
              <span className="text-black bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400">
                <WordReveal text="It Starts Conversations" delay={0.4} />
              </span>
            </h2>
            ...
            >
              Most outbound solutions focus on volume. We obsess over relevance and results. Every lead we source, 
              every message we write, and every sequence we launch is designed with one mission: to turn cold 
              prospects into warm opportunities for your business.
            </motion.p>
