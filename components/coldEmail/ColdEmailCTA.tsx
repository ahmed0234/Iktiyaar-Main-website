...
export default function ColdEmailCta() {
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-[2rem] sm:rounded-[2.5rem]">
            ...
            <div className="relative z-10 px-8 sm:px-12 lg:px-16 py-14 sm:py-16 lg:py-20 flex flex-col items-center text-center gap-8">
              ...
              >
                Ready to Turn Cold Outreach Into Predictable Revenue?
              </motion.h2>
              ...
              >
                Book a free Cold Email Strategy Audit. We&apos;ll analyze your current outbound
                efforts, identify high-intent prospect segments, and show you exactly how 
                to build an outreach engine that delivers verified leads and booked 
