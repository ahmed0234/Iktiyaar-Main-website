...
const approachSteps = [
  {
    ...
    description:
      "We define your ideal audience and create a focused outreach plan. Every campaign starts with deep research into your best-fit prospects.",
    details: [
      "ICP & Buyer Persona research",
      "Targeted lead list sourcing",
      "Campaign strategy & outreach roadmap",
    ],
    icon: Target,
    accentIcon: Users,
  ...
  },
  {
    ...
    subtitle: "Deliver the Message",
    description:
      "We send personalized email sequences with proper timing and structure. We ensure your messages stand out in the inbox and get opened.",
    details: [
      "Hyper-personalized copywriting",
      "Multi-step automated sequences",
      "Smart scheduling & timing optimization",
    ],
    icon: Rocket,
    accentIcon: Mail,
  ...
  },
  {
    ...
    subtitle: "Refine for Results",
    description:
      "We analyze performance and improve campaigns to increase results. Your outreach gets smarter and more effective as we collect data.",
    details: [
      "A/B testing of subject lines & copy",
      "Positive reply rate optimization",
...
/* ── Main Export ──────────────────────────────────────────────── */
export default function ColdEmailApproach() {
  ...
  return (
    <section
      ref={ref}
      className="relative py-16 sm:py-20 overflow-hidden bg-gradient-to-b from-slate-50/60 via-white to-slate-50/40"
    >
      {/* Subtle dot pattern */}
      <div
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16 lg:mb-20">
          ...
          >
            A proven 3 step framework that transforms cold outreach into a
            predictable revenue engine designed for high response rates and
            scalable growth.
          </motion.p>
        </div>
        ...
        >
          <p className="text-sm text-slate-400 font-semibold tracking-wide">
            No wasted emails. No ignored messages.{" "}
            <span className="text-blue-600 font-bold">
              Just high-converting outbound.
            </span>
          </p>
        </motion.div>
      </div>
