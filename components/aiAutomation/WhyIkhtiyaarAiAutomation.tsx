...
const differentiators = [
  {
    ...
    description:
      "We don't just automate tasks. We design smart, self-running workflows that adapt to your business needs and eliminate manual bottlenecks entirely.",
  },
  {
    icon: LineChart,
    title: "Peak Efficiency",
    description:
      "We leverage advanced AI models and continuous system testing to maximize your operational speed, driving down your overhead costs significantly.",
  },
  {
    icon: Sparkles,
    title: "Seamless Integration",
    description:
      "We build custom AI agents that connect effortlessly across your existing tech stack, creating a unified and powerful automated ecosystem.",
  },
  {
    icon: Globe,
    title: "24/7 Scalability",
    description:
      "We ensure your automated systems run continuously in the background, allowing your business to scale operations infinitely without increasing headcount.",
  },
];

export default function WhyIkhtiyaarAiAutomation() {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-[2.1rem] font-[900] tracking-tight text-slate-900 leading-[1.1] mb-6">
              <WordReveal text="AI Systems That Don’t Just Work" delay={0.1} />
              <br className="hidden sm:block" />
              <span className="text-black bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400">
                <WordReveal text="They Scale Growth" delay={0.4} />
              </span>
            </h2>
            ...
            >
              Most solutions focus on basic task automation. We obsess over intelligent optimization and scalability. Every workflow we map, every agent we build,
              and every system we deploy is designed with one mission: to eliminate manual drag and maximize your operational efficiency.
            </motion.p>
          ...
          >
            ...
            >
              <div className="relative w-full aspect-square">
                <Image
                  src="/AiAutomation/automation/chatbot.png"
            ...
            >
              ...
              >
                <Image
                  src="/AiAutomation/automation/automation_1.png"
