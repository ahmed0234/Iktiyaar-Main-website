...
const faqs = [
  {
    question: "AI sounds too complicated.",
    answer:
      "It doesn't have to be. We handle all the technical heavy lifting, from integration to prompt engineering. You just get a user-friendly, reliable system that works seamlessly in the background to make your life easier.",
  },
  {
    question: "Will automation replace human interaction?",
    answer:
      "Not at all. AI automation is designed to handle repetitive, low-value tasks so your team can focus their energy on meaningful, high-impact human interactions—like closing deals, building relationships, and strategizing.",
  },
  {
    question: "Is it expensive?",
    answer:
      "Think of it as an investment that pays for itself quickly. By eliminating manual work and reducing operational bottlenecks, our AI systems typically save enough time and resources to generate a massive ROI within the first few months.",
  },
  {
    question: "How long does it take to set up an automated system?",
    answer:
      "Most core workflows can be mapped, built, and deployed within 2 to 4 weeks. We work in agile sprints to ensure you start seeing efficiency gains as fast as possible without disrupting your current operations.",
  },
  {
    question: "What if my business processes change?",
    answer:
      "Our systems are built to be highly scalable and adaptable. As your business evolves, our AI agents and workflows can be easily refined, trained on new data, and scaled to handle new requirements without needing a complete rebuild.",
  },
];
