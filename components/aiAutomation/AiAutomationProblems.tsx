...
const struggles = [
  {
    text: "Manually responding to leads",
    icon: Ban,
    description: "Delayed responses cost you valuable opportunities.",
  },
  {
    text: "Managing data across tools",
    icon: CircleDollarSign,
    description: "Endless copy-pasting between disconnected platforms.",
  },
  {
    text: "Following up with customers",
    icon: SearchX,
    description: "Crucial touchpoints fall through the cracks.",
  },
  {
    text: "Handling routine operations",
    icon: Crosshair,
    description: "Your team is stuck on admin instead of growth.",
  },
];
...
// ═══════════════════════════════════════════════════════════════════════
export default function AiAutomationProblems() {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <p className="text-2xl font-[900] text-slate-800 leading-none">
                    40<span className="text-sm text-slate-400 font-bold">+</span>
                  </p>
                  <DecliningMetric />
                </div>
            ...
            >
              ...
              >
                ...
                <p className="text-[12px] font-[800] text-slate-700">
                  <span className="text-red-500">–60%</span> Lost Productivity
                </p>
              </motion.div>
            </motion.div>
          ...
          <div className="w-full lg:w-[55%]">
            ...
            >
              Most businesses waste time and money on repetitive tasks. Things like:
            </motion.p>
            ...
            >
              ...
              <div className="relative pl-5 border-l-[3px] border-red-400/50 max-w-lg">
                <p className="text-[15px] text-slate-500 leading-relaxed font-medium italic">
                  These tasks don&apos;t just take time they limit your ability to grow.{" "}
                  <span className="text-slate-800 font-bold not-italic">
                    And hiring more people only increases costs. The real solution isn&apos;t more effort. It&apos;s smarter systems.
                  </span>
                </p>
              </div>
            </motion.div>
