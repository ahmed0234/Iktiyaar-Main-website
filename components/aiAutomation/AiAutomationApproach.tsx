...
const approachSteps = [
  {
    step: "01",
    title: "Audit & Identify Opportunities",
    subtitle: "Map the Workflow",
    description:
      "We analyze your current processes and find areas where automation can create impact. Every solution starts with a deep understanding of your bottlenecks.",
    details: [
      "Comprehensive workflow & systems audit",
      "Identifying repetitive, high-cost manual tasks",
      "Strategic automation blueprint tailored to your goals",
    ],
    icon: Search,
    accentIcon: Target,
  ...
  },
  {
    ...
    subtitle: "Deploy Smart Solutions",
    description:
      "We design and implement AI-powered workflows tailored to your business. We connect your tools and data sources to create seamless, intelligent systems.",
    details: [
      "Custom AI agents and prompt engineering",
      "Seamless API integrations across your tech stack",
      "Automated routing, data entry, and responses",
    ],
    icon: Rocket,
  ...
  },
  {
    ...
    subtitle: "Compound Your Efficiency",
    description:
      "We refine systems over time to improve performance and support growth. Your automation gets smarter, faster, and more capable as your business evolves.",
    details: [
      "Continuous performance monitoring",
      "Iterative improvements to AI logic",
      "Scaling workflows to handle higher volume",
    ],
    icon: TrendingUp,
...
export default function AiAutomationApproach() {
  ...
  return (
    <section
      ref={ref}
      className="relative py-16 sm:py-12 overflow-hidden bg-gradient-to-b from-slate-50/60 via-white to-slate-50/40"
    >
      {/* Subtle dot pattern */}
      <div
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16 lg:mb-20">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-[3rem] font-[900] tracking-tight text-slate-900 leading-[1.1] mb-5">
            <WordReveal text="Our AI Automation" delay={0.1} />
          ...
          >
            A proven 3 step framework that transforms manual operations into intelligent, self-running workflows built for clarity, powered by AI, designed to scale.
          </motion.p>
        </div>
        ...
        >
          <p className="text-sm text-slate-400 font-semibold tracking-wide">
            No wasted hours. No bottlenecks.{" "}
